...
export const RegisterScreen = observer(({ navigation }: Props) => {
  ...
  const handleRegister = async () => {
    ...
    if (password !== confirmPassword) {
      rootStore.authStore.setError(t("auth.passwordMismatch"));
      return;
    }
    await rootStore.authStore.register(email, password);
